...
stringBuilding.AppendLine($"*     1:         Apple                                            *");
stringBuilding.AppendLine($"*     2:         Banana                                           *");
stringBuilding.AppendLine($"*     3:         Orange                                           *");
stringBuilding.AppendLine($"*     4:         Peach                                            *");
stringBuilding.AppendLine($"*     5:         Watermelon                                       *");
